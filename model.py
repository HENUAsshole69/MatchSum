...
class MatchSum(nn.Module):
    ...
    def forward(self, text_id, candidate_id, summary_id):
        ...
        out = self.encoder(summary_id, attention_mask=input_mask)  # last layer
        summary_emb = out
        ...
        out = self.encoder(candidate_id, attention_mask=input_mask)
        candidate_emb = out.view(batch_size, candidate_num,
